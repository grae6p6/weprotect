					...
					<div class="col-12 col-md-1 text-right">
						<div class="d-flex flex-row flex-md-column justify-content-center">
							<div class="p-sm-4 px-md-0 py-md-2">
								<a href="<?php echo $back_url ?>" alt="<?php _e( 'Go back', 'wep' ) ?>"><i
											class="fa fa-arrow-left fa-3x" aria-hidden="true"></i></a>
							</div>
							<div class="p-sm-4 px-md-0 py-md-2">
								<a href="#" alt="<?php _e( 'Print this page', 'wep' ) ?>"><i class="fa fa-print fa-3x"
																							 aria-hidden="true"></i></a>
							</div>
							<div class="p-sm-4 px-md-0 py-md-2">
								<a href="#" alt="<?php _e( 'E-mail this page', 'wep' ) ?>"><i
											class="fa fa-envelope-o fa-3x" aria-hidden="true"></i></a>
							</div>
							<div class="p-sm-4 px-md-0 py-md-2">
								<a href="#" alt="<?php _e( 'Share this page', 'wep' ) ?>"><i class="fa fa-share fa-3x"
																							 aria-hidden="true"></i></a>
							</div>
						</div>
					</div>
