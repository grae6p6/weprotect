...
if ( ! is_readable( $config_file_path ) ) {
	echo "ERROR: /shared/wp-tests-config.php is missing! Please use ~/data/wp-tests-config.php to create a config file.\n";
	exit( 1 );
}
...
$wp_theme_directories = array( dirname( __FILE__ ) . '/../../../src/wp-content/themes/wep' );
